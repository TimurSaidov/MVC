...
class MealListTableViewController: UITableViewController {
    ...
    func loadMeals() {
        meals += [
            ...
            Meal(name: "Беконайзер", photo: "bekonaizer.png", notes: "Cамый внушительный бургер. Бекон, двойная порция говядины на гриле, много сыра - все, как ты любишь, и ничего лишнего!", rating: 5, timestamp: Date()),
            ...
            Meal(name: "Стейкхауc", photo: "steikhaus.png", notes: "Стейкхаус – это сочетание приготовленной на огне 100% говядины с ломтиками бекона и соусом «Барбекю», майонезом, листьями свежего салата, помидором и хрустящим луком на воздушной булочке, посыпанной кукурузной крошкой.", rating: 5, timestamp: Date()),
            Meal(name: "Чизбургер", photo: "chizburger", notes: "Это фирменный приготовленный на огне бифштекс из 100% говядины с ломтиком слегка расплавленного сыра, хрустящим маринованным огурчиком, горчицей и кетчупом, которые подаются в подрумяненной булочке с кунжутом.", rating: 4, timestamp: Date())]
    }
